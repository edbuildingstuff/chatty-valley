# Elliott: in-game references batch

Concrete in-world facts, every one checked against `elliott-setting.md` sections 3, 9 and 11: gift
tastes and the two cucumbers he hands straight back, food and drink, the movie theater, all nine
festivals, and the small true details of a life on the beach. He has no personal quest, so none is
invented here.
...
- player: Use it well.
- elliott: I shall, on the opening chapter that keeps defeating me. Most of the bottle will go on crossings-out, and one good afternoon will justify the rest.
...
- elliott: A pomegranate! Thank you, @, I crave these all through spring, and opening one is a small ceremony for me.
- player: What ceremony?
- elliott: I open it over a plate, lose half the seeds regardless, and then call the mess artistic.

### elliott-ref-004
context: summer, clear evening, the Stardrop Saloon, 6 hearts, @ offering Crab Cakes (he loves it)
...
- elliott: Good heavens, a lobster! Thank you, @; that is a feast, and I have done nothing at all to deserve it.
- player: You are always on these docks. Call it rent.
- elliott: Then I accept it as rent, and gladly. I shall butter it and think generous thoughts about you.
...
- elliott: I know exactly what it is, and I cannot accept it, @. It is on my person, which is one place too many for it.
- player: Fine, I will put it back.
...
- elliott: Agh, it is still wriggling! Get that abomination away from me, @; I cannot accept it.
- player: You are being dramatic.
- elliott: A little, yes, and I still will not take it. Bring me a lobster instead and the whole episode is forgiven.
...
- elliott: In coin, perhaps. To me it is a desk ornament, and it will earn its keep by being looked at.

### elliott-ref-013
context: spring, clear evening, the Stardrop Saloon, 4 hearts, @ offering Milk (he dislikes it)
- player: Fresh from the barn this morning.
- elliott: Oh dear, I am afraid I do not care for milk of any kind, @. You have found one of my small ingratitudes.
- player: Noted. Anything else I should know?
- elliott: Pizza, I am afraid, and most things from the forest floor. Fruit or a book, on the other hand, and I am a happy man.
...
- elliott: They are, and I am afraid mushrooms do not agree with me, @. Everything that grows in that shade is a delight to look at and a disappointment to chew.
- player: You will not even try it?
- elliott: I have tried, along with leeks and wild roots and the rest of that earnest parade. My verdict was theatrical, and I was ashamed of myself for an hour afterward.
...
- elliott: Oh dear, I cannot bear amaranth, @. It sits on a short list with quartz and salmonberries, and I can pretend about none of the three.
- player: Harsh.
...
- elliott: You are generous, @, and I am about to be rude: I cannot abide salmonberries. They are the one fruit I keep my distance from.
- player: They are free food.
- elliott: They are, and that is the best argument anyone has made for them. I would still take one pomegranate over a bucket of these.

### elliott-ref-017
context: summer, clear morning, Elliott's cabin, 5 hearts
...
- elliott: Almost certainly; my liver is already drafting its complaint. I shall read it in the morning and disregard it by evening.
...
- player: Are you hunting eggs this year?
- elliott: Only a little; I came mostly for the break. Taking breaks from work can make you more productive in the long run.
...
- player: You came all this way on the bus?
- elliott: I did, and I have spent the morning appraising the sand the way other men appraise wine. The toe feel is milky, but with plenty of body.
- player: You are describing sand.
- elliott: I am describing sand at length, which is the only way I know how to do anything. Ours at the beach is coarser and prouder, since you ask.

### elliott-ref-024
context: spring, clear morning, the forest, 6 hearts, the Flower Dance
- player: You have scrubbed up well.
- elliott: I wore my best shirt for the dance! This sort of thing does not happen very often, and I intend to get every penny of wear out of the occasion.
- player: Nervous?
- elliott: Faintly. To dance among a whimsical backdrop of flowers is an uplifting experience, provided one's feet agree to cooperate.
...
- elliott: A little. If we keep polluting the oceans the jellies will surely go extinct, and it is already in the process of happening. We have so little respect left for nature.
...
- player: You are enjoying this far too much.
- elliott: I am, I confess; Spirit's Eve brings out the gothic in me. Oh pitiful wretch! In what fetid grotto lies your kingdom?
- player: I am going to walk away now.
...
- elliott: My secret weapon. A flask of fine spirits, to wet my lips a moment before the whistle sounds.
- player: That is cheating.
- elliott: It is ceremony, @, and it helps nobody catch a fish. I never stand a chance anyway, and I always participate just to be sporting.
...
- elliott: That is kind of you. Winter is my season for books and piano, and I do both to about the same standard.

### elliott-ref-032
context: spring, clear morning, Elliott's cabin, 4 hearts
- player: Is that rose all right?
- elliott: It looks a touch wilted to me, I am afraid. It may simply be doing what a rose does in a dark room.
- player: More water, maybe.
- elliott: I must remember to water my plants today. And not with sea water this time.

### elliott-ref-033
context: fall, clear evening, Elliott's cabin, 5 hearts
- player: What is the little tree for?
- elliott: My bonsai. I stand in front of it most fall evenings, snip almost nothing, and return to the desk feeling like a wise man.
- player: Does it help the writing?
- elliott: Yes, enormously, by a mechanism I could not defend to you for a moment.
...
- player: What are you shaking out there?
- elliott: Oh dear! My shoes are filled with sand again. That is the trouble with living on the beach.
- player: Could be worse.
- elliott: It has been. A tiny crab made his home in my shirt pocket and I discovered him halfway up the road to town, which livened the walk considerably.
...
- elliott: Very likely. It costs me one walk to the door and buys me a clear conscience for the afternoon.
...
- player: Got any jobs for me?
- elliott: None of my own, I am afraid. My whole enterprise fits on one desk, and I am the only person it can order about.
- player: There is a board outside, though.
- elliott: The Help Wanted board, yes. I have been known to pin a small request to it when the cupboard turns abstract, and somebody kind usually obliges.
